            ...
            <div className="col-lg-12 col-md-12 mb-5">
              <div className="blog-item">
                ...
                <div className="blog-item-content">
                  ...
                  <h2 className="mt-3 mb-3"><NavLink to="/blogsingle">Choose quality service over cheap service  all type of things</NavLink></h2>
                  ...
                  <NavLink to="/blogsingle"  className="btn btn-main btn-icon btn-round-full">Read More <i className="icofont-simple-right ml-2  " /></NavLink>
                </div>
              </div>
            </div>
            <div className="col-lg-12 col-md-12 mb-5">
              <div className="blog-item">
                ...
                <div className="blog-item-content">
                  ...
                  <h2 className="mt-3 mb-3"><a to="/blogsingle">All test cost 25% in always in our laboratory</a></h2>
                  <p className="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis aliquid architecto facere commodi cupiditate omnis voluptatibus inventore atque velit cum rem id assumenda quam recusandae ipsam ea porro, dicta ad.</p>
                  <NavLink to="/blogsingle"  className="btn btn-main btn-icon btn-round-full">Read More <i className="icofont-simple-right ml-2  " /></NavLink>
                </div>
              </div>
            ...
            <div className="col-lg-12 col-md-12 mb-5">
              <div className="blog-item">
                ...
                <div className="blog-item-content">
                  ...
                  <h2 className="mt-3 mb-3"><a to="/blogsingle">Get Free consulation from our special surgeon and doctors</a></h2>
                  <p className="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis aliquid architecto facere commodi cupiditate omnis voluptatibus inventore atque velit cum rem id assumenda quam recusandae ipsam ea porro, dicta ad.</p>
                  <NavLink to="/blogsingle"  className="btn btn-main btn-icon btn-round-full">Read More <i className="icofont-simple-right ml-2  " /></NavLink>
                </div>
              </div>
