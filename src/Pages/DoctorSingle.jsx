      ...
      <div className="row">
        ...
        <div className="col-lg-8 col-md-6">
          <div className="doctor-details mt-4 mt-lg-0">
            ...
            <NavLink to="/appoinment" className="btn btn-main-2 btn-round-full mt-3">Make an Appoinment<i className="icofont-simple-right ml-2  " /></NavLink>
          </div>
        </div>
      </div>
    </div>
